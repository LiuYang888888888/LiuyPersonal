    ...
    return {
      ...
      faqBasicFormOption: {
        column: [
          ...
          {
            label: this.$t("smalltalk.categoryId"),
            prop: "caId",
            span: 24,
            display: false,
          },
  ...
  methods: {
    ...
    saveFaqBasic() {
      ...
      this.faqBasicFormData.formAnswers.forEach((item, index) => {
        if (index === 0) {
          if (item.answers === "") {
            this.$message({
              type: "warning",
              message: this.$t("smalltalk.fillAnswerTips"),
            });
            flag = true;
          }
        } else {
          if (item.answers === "" && item.perspectives.length === 0) {
            ...
            if (document.getElementsByClassName("el-message").length === 0) {
              this.$message({
                type: "warning",
                message: this.$t("smalltalk.answerOrPerspectiveTips"),
              });
            }
          } else {
            if (item.answers === "") {
            ...
            if (item.perspectives.length === 0) {
              ...
              if (document.getElementsByClassName("el-message").length === 0) {
                this.$message({
                  type: "warning",
                  message: this.$t("smalltalk.perspectiveTips"),
                });
              }
            }
          }
      ...
      if (listLength > newListLength) {
        this.$message.warning(this.$t("smalltalk.repeatedTips"));
        flag = true;
      }

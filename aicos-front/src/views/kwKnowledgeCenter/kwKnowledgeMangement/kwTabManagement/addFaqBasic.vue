...
export default {
  ...
  data() {
    ...
    return {
      ...
      treeOption: {
        ...
        load: (node, resolve) => {
          ...
          if (node.level === 0) {
            ...
            resolve([
              {
                dname: this.$t("table.overallSituation"),
                id: "0",
                disabled: true,
              },
            ]);
      ...
      answerPerspectives: [
        {
          label: this.$t("table.perspective"),
          value: "123",
        },
      ],
      faqBasicFormData: {
        ...
        column: [
          ...
          },
          {
            ...
            rules: [
              ...
              // ...getRules(["charNumHanCommaStopTable"]),
            ],
          },
          {
            type: "input",
          ...
          },
          {
            ...
            rules: [
              { required: true, message: this.$t("table.relatedIntention") },
              // ...getRules(["charNumHan"]),
            ],
            prop: "intentionId",
          },
      ...
      handler(newVal) {
        if (this.faqType != "view") {
          this.faqBasicFormOption.labelPosition =
            newVal != "zh" ? "top" : "right";
          this.faqBasicFormOption.labelWidth = 130;
        } else {
          this.faqBasicFormOption.labelPosition = "right";
          this.faqBasicFormOption.labelWidth = 220;
        }
      },
      immediate: true,
    },

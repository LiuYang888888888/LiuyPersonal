        ...
        <van-cell-group inset>
          <van-swipe-cell v-for="item in list" :key="item">
            ...
            <template #right>
              ...
              <van-button square type="danger" text="编辑" v-if="permissionList.updateBtn" @click="comFormMagUpdate(item)"
                style="border-right: 1px solid #fff;" />
              <van-button square type="danger" text="提交" v-if="permissionList.submit && item.zhuangt === '1'"
                @click="comFormTijiao(item)" style="border-right: 1px solid #fff;" />
              <van-button square type="danger" text="审核" v-if="permissionList.examineBtn && item.zhuangt === '2'"
                @click="comFormShenhe(item)" style="border-right: 1px solid #fff;" />

    ...
    >
      ...
      <!-- <template slot-scope="scope" slot="menu">
        <el-button
          ...
          size="small"
          v-if="permissionList.myInitedHandle"
...
import { getList, getItemInfo } from "@/api/mywork/myInitiated";
  ...
  computed: {
    ...
    permissionList() {
      return {
        ...
        // delBtn: false,
        // editBtn: false,
        myInitedHandle: this.vaildData(
          this.permission["mywork-myInited-handle"],
          false
        ),
      };
    },

<template>
  <div class="all">
    <div class="main">
      <img src="../../../public/img/keshihua/beijing2.png" class="main-img" />
      <!--顶部标题-->
      <div class="main-top">
        <img src="../../../public/img/keshihua/top.png" class="top-img" />
      </div>
      ...
      <div class="main-content">
        ...
        <div class="main-left">
          <!--用户统计-->
          <div class="yonghu">
            <img src="../../../public/img/keshihua/yinying.png" class="yinying" />
            <!--用户统计标题-->
            <div class="biaoti">
              <img src="../../../public/img/keshihua/biaoti.png" class="biaoti-img" />
              <div class="biaoti-left">
                <div class="dian"><img src="../../../public/img/keshihua/dian.png" /></div>
                <div class="biaoti-text">用户统计</div>
              </div>
            </div>
            <div class="yhtongji">
              <!--用户总量-->
              <div id="yonghuall" class="yonghuall"></div>
              <!--用户分布-->
              <div class="yhfenbu">
                <div class="yonghufenbu" @click="qiye">
                  <img src="../../../public/img/keshihua/juxing1.png" class="yhfbimg" v-if="qiyeimg" />
                  <img src="../../../public/img/keshihua/juxing2.png" class="yhfbimg" v-else />
                  <div class="yhfbcon"><span class="yhfb-title">企业用户</span> <span class="yhfb-num"> 1024</span></div>
                </div>

                <div class="yonghufenbu" @click="fuwu">
                  <img src="../../../public/img/keshihua/juxing1.png" class="yhfbimg" v-if="fwimg" />
                  <img src="../../../public/img/keshihua/juxing2.png" class="yhfbimg" v-else />
                  <div class="yhfbcon"><span class="yhfb-title">服务机构</span> <span class="yhfb-num"> 1024</span></div>
                </div>

                <div class="yonghufenbu" @click="keyan">
                  <img src="../../../public/img/keshihua/juxing1.png" class="yhfbimg" v-if="kyimg" />
                  <img src="../../../public/img/keshihua/juxing2.png" class="yhfbimg" v-else />
                  <div class="yhfbcon"><span class="yhfb-title">科研院所</span> <span class="yhfb-num"> 1024</span></div>
                </div>

                <div class="yonghufenbu" @click="geren">
                  <img src="../../../public/img/keshihua/juxing1.png" class="yhfbimg" v-if="grimg" />
                  <img src="../../../public/img/keshihua/juxing2.png" class="yhfbimg" v-else />
                  <div class="yhfbcon"><span class="yhfb-title">个人用户</span> <span class="yhfb-num"> 1024</span></div>
                </div>
              </div>
            </div>
          ...
          <div class="xuqiu">
            ...
            <div class="biaoti">
              ...
              <div class="biaoti-left">
                <div class="dian"><img src="../../../public/img/keshihua/dian.png" /></div>
                <div class="biaoti-text">需求统计</div>
              </div>
            </div>

            <div class="yhtongji">
              <!--需求统计统计-->
              <div id="xuqiuall" class="jishuall"></div>
            </div>
          </div>
          ...
          <div class="xuqiu">
            ...
            <div class="biaoti">
              ...
              <div class="biaoti-left">
                <div class="dian"><img src="../../../public/img/keshihua/dian.png" /></div>
                <div class="biaoti-text">技术产品统计</div>
              </div>
            </div>

            <div class="yhtongji">
              <!--技术产品统计-->
              <div id="jishuall" class="jishuall"></div>
            </div>
          </div>
        </div>
        ...
        <div class="main-mid">
          ...
          <div id="map" class="map">
            <img src="../../../public/img/keshihua/map.png" class="map-img" />
          </div>
          ...
          <div class="xuqiu">
            ...
            <div class="yhtongji">
              <!--技术产品统计-->
              <div id="jishumid" class="jishuall"></div>
            </div>
          </div>
        </div>
        ...
        <div class="main-right">
          ...
          <div class="yonghu">
            ...
            <div class="biaoti">
              ...
              <div class="biaoti-left">
                <div class="dian"><img src="../../../public/img/keshihua/dian.png" /></div>
                <div class="biaoti-text">设备统计</div>
              </div>
            </div>
            <div class="yhtongji">
              <!--设备统计-->
              <div id="shebeiall" class="shebeiall"></div>
            </div>
          </div>
          ...
          <div class="xuqiu">
            ...
            <div class="biaoti">
              ...
              <div class="biaoti-left">
                <div class="dian"><img src="../../../public/img/keshihua/dian.png" /></div>
                <div class="biaoti-text">服务机构统计</div>
              </div>
            </div>

            <div class="yhtongji">
              <!--服务机构统计-->
              <div id="fuwuall" class="fuwuall"></div>
            </div>
          </div>
          ...
          <div class="xuqiu">
            ...
            <div class="biaoti">
              ...
              <div class="biaoti-left">
                <div class="dian"><img src="../../../public/img/keshihua/dian.png" /></div>
                <div class="biaoti-text">企业统计</div>
              </div>
            </div>

            <div class="yhtongji">
              <!--企业统计-->
              <div id="qiyeall" class="qiyeall">
                <div class="qiyeList">
                  <div class="qiye-left"><img src="../../../public/img/keshihua/qiye1.png" class="qiyeimg" /> </div>
                  <div class="qiye-mid">
                    <div class="qiye-mid-title">国有企业</div>
                    <div class="qiye-mid-chang">
                      <div class="qiye-mid-chang2"></div>
                    </div>
                  </div>
                  <div class="qiye-num">31</div>
                  <div class="qiye-precent">5%</div>
                </div>

                <div class="qiyeList">
                  <div class="qiye-left"><img src="../../../public/img/keshihua/qiye2.png" class="qiyeimg" /> </div>
                  <div class="qiye-mid">
                    <div class="qiye-mid-title">集体企业</div>
                    <div class="qiye-mid-chang">
                      <div class="qiye-mid-chang2-jiti"></div>
                    </div>
                  </div>
                  <div class="qiye-num-jiti">108</div>
                  <div class="qiye-precent">25%</div>
                </div>

                <div class="qiyeList">
                  <div class="qiye-left"><img src="../../../public/img/keshihua/qiye3.png" class="qiyeimg" /> </div>
                  <div class="qiye-mid">
                    <div class="qiye-mid-title">私有企业</div>
                    <div class="qiye-mid-chang">
                      <div class="qiye-mid-chang2-siyou"></div>
                    </div>
                  </div>
                  <div class="qiye-num-siyou">31</div>
                  <div class="qiye-precent">5%</div>
                </div>

                <div class="qiyeList">
                  <div class="qiye-left"><img src="../../../public/img/keshihua/qiye4.png" class="qiyeimg" /> </div>
                  <div class="qiye-mid">
                    <div class="qiye-mid-title">股份制企业</div>
                    <div class="qiye-mid-chang">
                      <div class="qiye-mid-chang2-gufen"></div>
                    </div>
                  </div>
                  <div class="qiye-num-gufen">53</div>
                  <div class="qiye-precent">10%</div>
                </div>

                <div class="qiyeList">
                  <div class="qiye-left"><img src="../../../public/img/keshihua/qiye5.png" class="qiyeimg" /> </div>
                  <div class="qiye-mid">
                    <div class="qiye-mid-title">有限责任公司</div>
                    <div class="qiye-mid-chang">
                      <div class="qiye-mid-chang2-zeren"></div>
                    </div>
                  </div>
                  <div class="qiye-num-zeren">107</div>
                  <div class="qiye-precent">24%</div>
                </div>
      ...
      <div class="main-middle">
        <img src="../../../public/img/keshihua/middle.png" />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    // drawnewpie () {
    //   var that = this
    //   let chartDom = document.getElementById('yonghuall');
    ...
    drawxuqiu () {
      ...
      var symbolSizeData = [90, 80, 60, 50, 110];
      //循环定义series的data值
      var datas = [];
      ...
      var itemList = [
        {
          normal: {
            color: new echarts.graphic.RadialGradient(0.3, 0.5, 0.7, [{
              offset: 0,
              color: "rgba(76,149,246,1)"
            },
            {
              offset: 1,
              color: "rgba(29,117,235,1)"
            }
            ]),
            opacity: 0.8,
            shadowColor: '#1f76ec',
...

        {
          normal: {
            color: new echarts.graphic.RadialGradient(0.3, 0.5, 0.7, [{
              offset: 0,
              color: "rgba(77,243,225,1)"
            },
            {
              offset: 1,
              color: "rgba(40,211,192,1)"
            }
            ]),
            opacity: 0.8,
            shadowColor: '#28d3c0',
...

        {
          normal: {
            color: new echarts.graphic.RadialGradient(0.3, 0.5, 0.7, [{
              offset: 0,
              color: "rgba(200,178,110,1)"
            },
            {
              offset: 1,
              color: "rgba(232,182,48,1)"
            }
            ]),
            opacity: 0.8,
            shadowColor: '#e8b62f',
...

        {
          normal: {
            color: new echarts.graphic.RadialGradient(0.3, 0.5, 0.7, [{
              offset: 0,
              color: "rgba(216,149,244,1)"
            },
            {
              offset: 1,
              color: "rgba(181,94,218,1)"
            }
            ]),
            opacity: 0.8,
            shadowColor: '#b55eda',
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        datas.push({
          ...
          itemStyle: itemList[i]
        });
      }
      let chartDom = document.getElementById('xuqiuall');
      let myChart = echarts.init(chartDom);
      let option;
      option = {
        grid: {
    ...
    //技术产品统计
    drawline () {
      let chartDom = document.getElementById('jishuall');
      let myChart = echarts.init(chartDom);
      let option;
      option = {
    ...
    //中间技术产品统计
    drawlinemid () {
      let chartDom = document.getElementById('jishumid');
      let myChart = echarts.init(chartDom);
      let option;
      option = {
        title: {
        ...
        series: [
          {
            name: '上传量',
            type: 'line',
            data: [2000, 2500, 3000, 3100, 3500, 4000, 4100, 4500, 5000],
            smooth: true,
            color: '#1D87F0',
            lineStyle: {
              width: 2
          ...
          {
            name: '下载量',
            data: [1000, 1500, 2000, 2100, 2500, 3000, 3100, 3500, 4000],
            type: 'line',
            smooth: true,
            color: '#00F7FF',
            lineStyle: {
    ...
    drawpieshebei () {
      ...
      let chartDom = document.getElementById('shebeiall');
      let myChart = echarts.init(chartDom);
      let option;
      ...
      option = {
        ...
        color: ["#0e6de9", "#22ed77", "#e6af08", "#f75034"],
        series: [
          {
            name: data[0].name,
            type: 'pie',
    ...
    //服务机构统计
    drawfuwu () {
      let chartDom = document.getElementById('fuwuall');
      let myChart = echarts.init(chartDom);
      let option;
...
<style scoped>
.all {
  background: url("../../../public/img/keshihua/beijing.png");
  width: 100%;
  height: 100%;
  position: relative;
}
...
.yhfb-num {
  background: linear-gradient(rgb(147, 234, 255), rgb(236, 251, 255));
...
.qiye-mid-chang2 {
  width: 5%;
  height: 100%;
  background: linear-gradient(to right, #274c75, #f4a205);
  border-radius: 10px;
}

.qiye-mid-chang2-jiti {
  width: 25%;
  height: 100%;
  background: linear-gradient(to right, #274c75, #fdef02);
  border-radius: 10px;
}

.qiye-mid-chang2-siyou {
  width: 67%;
  height: 100%;
  background: linear-gradient(to right, #274c75, #26fbff);
  border-radius: 10px;
}

.qiye-mid-chang2-gufen {
  width: 10%;
  height: 100%;
  background: linear-gradient(to right, #274c75, #17a8e7);
  border-radius: 10px;
}

.qiye-mid-chang2-zeren {
  width: 24%;
  height: 100%;
  background: linear-gradient(to right, #274c75, #f94c30);
  border-radius: 10px;
}

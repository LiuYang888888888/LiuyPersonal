...
export default {
  ...
  methods: {
    ...
    handleNodeClick(data, node, comp) {
      ...
      console.log("this.treeOpt.showCheckbox || node.disabled------",this.treeOpt.showCheckbox || node.disabled)
...
/deep/ .tree-scrollbar-wrapper {
  max-height: 50vh;
}
/deep/ .tree-select-popover {
  .el-tree-node {
    .selected {
      color: #409eff;
      font-weight: 700;

          ...
          <template v-slot:header>
            ...
            <div class="toolBoxHeader">
              ...
              <div class="toolBoxRadio">
                <el-radio-group v-model="time" @input="changetime">
  ...
  methods:{
    ...
    changetime(){
      if(this.time == '今日'){
        ...
        this.areaNum = [20, 12, 50 , 12, 6, 5]
      }else if(this.time == '本周'){
        this.lineInfo = [
          { value: 36, name:  '待审批' },
          { value: 20, name:  '审批中' },
          { value: 40, name:  '已审批' },
        ...
        this.areaNum = [40, 22, 60 , 22, 18, 21]
      }else{
        this.lineInfo = [
          { value: 56, name:  '待审批' },
          { value: 30, name:  '审批中' },
        ...
        this.areaNum = [60, 32, 80 , 32, 28, 31]
      }
    }
  }
}

          ...
          <div class="user-box" v-for="(item, index) in userList" :key="index">
            ...
            <div class="user-info">
              ...
              <div class="info-box">
                ...
                <div class="info-content" v-if="item.extendField1 == 1">：企业用户</div>
                <div class="info-content" v-if="item.extendField1 == 2">：科研院所</div>
                <div class="info-content" v-if="item.extendField1 == 3">：服务机构</div>
                <div class="info-content" v-if="item.extendField1 == 4">：个人游客</div>
              </div>
            </div>
          </div>
        </div>

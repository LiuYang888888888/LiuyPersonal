          ...
          <div class="kw-header">
            <div id="kw-form-container" style="margin: 0px; padding: 0">
              <div class="kw-form-form">
                <el-input size="small" :placeholder="$t('aicosCommon.pleaseInput') + $t('smalltalk.question')"
...
import { loadListUrl } from "@/api/kwKnowledgeCenter/kwKnowledgeMangement/smalltalk/index";

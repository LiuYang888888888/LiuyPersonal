...
const { system, auth, material } = serviceList

// 根据id取子文件夹，传id,folderType
export const getChildrenMaterialFolder = (data) => {
  return request({
    url: `${baseURL}api/${material}/materialFolder/getBaseMaterialFolderByParentIdAndFolderType`,
    method: 'post',
    data
  })
}
...
export const remove = (id) => {
  return request({
    url: `${baseURL}api/${system}/baseUser/delete`,
    method: 'post',
    data: {
      id,
    }

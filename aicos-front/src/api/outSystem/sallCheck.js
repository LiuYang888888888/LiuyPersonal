...
export const getById = (params) => {
  return request({
    url: `${baseURL}api/aicos-second/mbj/salesLicense/getById`,
    method: 'post',
    data: params,
...
export const importExcel = (row) => {
  return request({
    url: `${baseURL}api/aicos-second/mbj/salesLicense/importExcel`,
    method: 'post',
    data: row
  })
}
...
export const importTemplateFile = (row) => {
  return request({
    url: `${baseURL}api/aicos-second/mbj/salesLicense/importTemplateFile`,
    method: 'post',
    data: row
  })
}

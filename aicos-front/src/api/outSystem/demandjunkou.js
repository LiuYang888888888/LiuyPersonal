...
export const add = (row) => {
  return request({
    url: `${baseURL}api/aicos-second/member/requirementJKInformation/saveOrUpdateFormData`,
    method: 'post',
    data:row
  })
}
...
export const remove = (params) => {
  return request({
    url: `${baseURL}api/aicos-second/member/requirementJKInformation/delete`,
    method: 'post',
    data: params,
    headers:{'Content-Type':'application/x-www-form-urlencoded'}
  })
...
export const getById = (params) => {
  return request({
    url: `${baseURL}api/aicos-second/member/requirementJKInformation/getById`,
    method: 'post',
    data: params,
    headers:{'Content-Type':'application/x-www-form-urlencoded'}
  })
...
export const exportExcel = (row) => {
  return request({
    url: `${baseURL}api/aicos-second/member/requirementJKInformation/exportExcel`,
    method: 'post',
    data: row
  })
}

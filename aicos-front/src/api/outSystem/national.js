...
export const getById = (params) => {
  return request({
    url: `${baseURL}api/aicos-second/mbj/patentAgency/getById`,
    method: 'post',
    data: params,
...
export const saveOrUpdateListData = (row) => {
  return request({
    url: `${baseURL}api/aicos-second/mbj/patentAgency/saveOrUpdateFormData`,
    method: 'post',
    data: row
  })
}
...
export const delListData = (id) => {
  return request({
    url: `${baseURL}api/aicos-second/mbj/patentAgency/delete`,
    method: 'post',
    headers:{'Content-Type':'application/x-www-form-urlencoded'},
    data: id
  })
...
export const exportExcel = (row) => {
  return request({
    url: `${baseURL}api/aicos-second/mbj/patentAgency/exportExcel`,
    method: 'post',
    data: row
  })
}
...
export const importExcel = (row) => {
  return request({
    url: `${baseURL}api/aicos-second/mbj/patentAgency/importExcel`,
    method: 'post',
    data: row
  })
}
...
export const importTemplateFile = (row) => {
  return request({
    url: `${baseURL}api/aicos-second/mbj/patentAgency/importTemplateFile`,
    method: 'post',
    data: row
  })
}

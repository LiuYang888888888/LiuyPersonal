...
export const getById = (params) => {
  return request({
    url: `${baseURL}api/aicos-second/mbj/securityAdministration/getById`,
    method: 'post',
    data: params,
...
export const auditListData = (data) => {
  return request({
    url: `${baseURL}api/aicos-second/mbj/securityAdministration/complete`,
    method: 'post',
    headers:{'Content-Type':'application/x-www-form-urlencoded'},
    data:data
  })
...
export const auditNoListData = (data) => {
  return request({
    url: `${baseURL}api/aicos-second/mbj/securityAdministration/disagree`,
    method: 'post',
    headers:{'Content-Type':'application/x-www-form-urlencoded'},
    data:data
  })

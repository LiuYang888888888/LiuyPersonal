  ...
  methods: {
    ...
    beforeOpen (done, type) {
      ...
      danwei().then(res =>{
        ...
        const column = this.findObject(this.option.column, "jesdwdm");
        column.dicData = res.data.data;
      })
      if (["add","edit", "view"].includes(type)) {
        if(type == "edit"){
          console.log(this.form.jesdwdm)
          this.form.jesdwdm = this.form.jesdwdm.split(",")
        }
      }
      done();
    },

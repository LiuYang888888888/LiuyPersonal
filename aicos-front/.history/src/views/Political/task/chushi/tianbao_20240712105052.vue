<template>
  <basic-container>
    ...
    <HuilanBasicToolbar style="margin-top: 0;text-align: left;" v-if="tabType == 'ALL' && role">
    ...
    <avue-crud :option="option" :table-loading="loading" :data="data" :page="page" :permission="permissionList"
      ...
      <template v-slot:menu="scope">
        <el-button type="text" size="small" v-if="permissionList.viewBtn && tabType != 'TODO'"
    ...
    <HuilanDialog :title="dataMagFormTitle" :fullscreen="true" append-to-body :before-close="dataMagFormClose"
      ...
      <div class="dataMagFormBody" v-if="verifyTab == 'VIEW'">
        <div class="CMF_MAIN">
          ...
          <div class="CMF_BODY">
            <avue-form id="dataMagFormView" ref="dataMagFormRef" v-model="form" :option="option5" v-if="showform">
            </avue-form>
          </div>
        </div>
...
import { czflowNo,czflowYes,role } from "@/api/Political/common";
import {
  getList,
  getListSubmit,
  addSubmit,

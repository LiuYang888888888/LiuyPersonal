  ...
  <basic-container>
    ...
    <avue-crud :option="option" :table-loading="loading" :data="data" :page="page" :permission="permissionList"
      ...
      <template v-slot:menu="scope">
        ...
        <el-button type="text" size="small" v-if="role || tabType == 'DONE'"
    ...
    <HuilanDialog :title="dataMagFormTitle" :fullscreen="true" append-to-body :before-close="dataMagFormClose"
      ...
      <div class="dataMagFormBody" v-if="verifyTab == 'VIEW'">
        <div class="CMF_MAIN">
          ...
          <div class="CMF_BODY">
            <avue-form id="dataMagFormView" ref="dataMagFormRef" v-model="form2" :option="option2" v-if="!role2">
            </avue-form>
            <avue-form id="dataMagFormView2" ref="dataMagFormRef2" v-model="form3" :option="option3" v-if="role2">
            </avue-form>
            <avue-form id="dataMagFormView4" ref="dataMagFormRef2" v-model="form4" :option="option4" v-if="tabType == 'DONE'">
            </avue-form>
          </div>
        </div>
        <div class="dataMagFormFooter">
          ...
          <div class="dataMagFormBtns">
            <el-button size="small" icon="el-icon-check" v-if="formVerify && tabType == 'TODO' && dataMagFormSubType != 'add'
      " type="success" @click.stop="dataMagVerifyYes" :loading="btnLoading">审核通过
            </el-button>
            <el-button size="small" icon="el-icon-close"
              v-if="formVerify && tabType == 'TODO' && dataMagFormSubType != 'add'" type="warning"

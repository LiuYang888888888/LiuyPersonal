<template>
  <basic-container>
    ...
    <!--流程列表弹窗-->
    <HuilanDialog :title="dataMagFormTitlelc" :fullscreen="true" append-to-body :before-close="dataMagFormClose"
...
import { getList, add, update, remove, tijiao, role ,getprocessId} from "@/api/Political/common";
import {
...
export default {
  ...
  methods: {
    ...
    comFormMagVerify (row) {
      if (this.rolename.includes("政治部") < 0) {
      ...
      if (this.role2) {
        this.$refs.dataMagFormRef2.validate((valid /*msg*/) => {
          if (valid) {
            ...
            this.form3.datetime_zhengzbsdrq = this.zhengzhidate
            this.form3.string_zhengzbsd = this.zhengzhival

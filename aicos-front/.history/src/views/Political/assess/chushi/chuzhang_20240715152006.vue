<template>
  <basic-container>
    ...
    <div class="search-from-tool">
      <div class="el-form-item el-form-item--small avue-form__item--left" label-position="left"><label for="tianbny1" class="el-form-item__label" style="width: 80px;">填报年月:</label><div class="el-form-item__content" style="margin-left: 80px;"><!---->  <div disabled="disabled" content="填报年月"><div class="avue-date" column-slot="menuForm,search" search="true" span="6" gutter="20" labelwidth="80" display="true"><div class="el-date-editor el-input el-input--small el-input--prefix el-input--suffix el-date-editor--month"><!----><input type="text" autocomplete="off" name="" placeholder="填报年月" class="el-input__inner"><span class="el-input__prefix"><i class="el-input__icon el-icon-date"></i><!----></span><span class="el-input__suffix"><span class="el-input__suffix-inner"><i class="el-input__icon"></i><!----><!----><!----><!----></span><!----></span><!----><!----></div></div></div><!----></div></div>
      <div class="el-col el-col-6 el-col-xs-24 el-col-sm-12 el-col-md-6 avue-form__menu avue-form__menu--center no-print" style="padding: 0px;">
        <div class="el-form-item el-form-item--small">
          <div class="el-form-item__content" style="margin-left: 0px;">
            ...
            <button type="button" class="el-button el-button--default el-button--small">
              <i class="el-icon-delete"></i><span>清 空</span>
            </button>
          </div>
        </div>
      </div>
    ...
    async beforeOpen (done, type) {
      if (["add", "edit", "view"].includes(type)) {
        if(type == "add"){
          ...
          this.form.suoscs = dept.data.data.deptName
        }
        this.initData(type);
      }
      done();

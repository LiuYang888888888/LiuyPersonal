...
import DiagramView from "@/views/system/commonFormData/diagramView";
import CirculationHistory from "@/views/system/commonFormData/circulationHistory";
export default {
  components: {
    DiagramView,
    CirculationHistory,

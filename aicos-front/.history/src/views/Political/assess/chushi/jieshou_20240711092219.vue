  ...
  <basic-container>
    <avue-crud :option="option" :table-loading="loading" :data="data" :page="page" :permission="permissionList"
      ...
      <template v-slot:menu="scope">
        <el-button type="text" size="small" v-if="permissionList.jieshouBtn"
    ...
    >
      ...
      <div class="tztop">根据我办公务员平时考核方案，2024年第一季度你处“好”等次人数如下：</div>
      <el-table
        :data="tableData"
        height="300"
        border
...
export default {
  ...
  methods: {
    ...
    onLoad (page, params = {}) {
      ...
      getJieshou(page.currentPage, page.pageSize, Object.assign(params, this.query)).then(res => {

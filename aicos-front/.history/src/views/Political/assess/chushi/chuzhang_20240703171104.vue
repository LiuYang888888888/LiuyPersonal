  ...
  methods: {
    ...
    async comFormMagVerify (row) {
      ...
      if(this.rolefinal == 3){
        ...
        console.log(this.option2.column[8].data[10][1].children[0].disabled)
        this.option2.column[8].data[10][1].children[0].disabled = false
      }
    ...
    //审核通过
    async dataMagVerifyYes (done, loading) {

  ...
  <basic-container>
    <avue-crud :option="option" :table-loading="loading" :data="data" :page="page" :permission="permissionList"
      ...
      <template v-slot:menu="scope">
        <el-button type="text" size="small" v-if="!scope.row.shiftj"
          @click="handleUpdate(scope.row,scope.index)">查看
        </el-button>
        <el-button type="text" size="small" v-if="!scope.row.shiftj"
          @click="handleUpdate(scope.row,scope.index)">编辑
        </el-button>
        <el-button type="text" size="small" v-if="permissionList.kqtjBtn && !scope.row.shiftj"
          @click="comFormMagkqtj(scope.row)">提交
        </el-button>
        <el-button type="text" size="small" v-if="!scope.row.shiftj"
          @click="handelDel(scope.row,scope.index)">删除
        </el-button>
      </template>
    </avue-crud>
  </basic-container>
...
import { getList , add , update , remove ,tijiao} from "@/api/Political/common";

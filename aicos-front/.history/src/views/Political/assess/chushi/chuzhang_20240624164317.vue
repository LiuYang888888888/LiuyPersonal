      ...
      <div class="dataMagFormBody" v-if="verifyTab == 'VIEW'">
        <div class="CMF_MAIN">
          ...
          <div class="CMF_BODY">
            ...
            <avue-form id="dataMagFormView" ref="dataMagFormRef" v-model="form3" :option="option3" v-if="tabType == 'TODO' && rolefinal == 3">
            </avue-form>
...
export default {
  ...
  methods: {
    ...
    async roleInfo () {
      ...
      this.form.yongh = userinfo.data.data.realName
      this.form.xingm = userinfo.data.data.realName
      this.form.xingb = userinfo.data.data.realName

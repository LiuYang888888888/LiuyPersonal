  ...
  <basic-container>
    ...
    <avue-crud :option="option" :table-loading="loading" :data="data" :page="page" :permission="permissionList"
      ...
      <template v-slot:menu="scope">
        ...
        <el-button type="text" size="small" v-if="(scope.row.shiftj == '草稿' || scope.row.shiftj == '审核不通过') && role"
          @click="handleUpdate(scope.row, scope.index)">编辑
        </el-button>
        <el-button type="text" size="small" v-if="role"
...
export default {
  ...
  methods: {
    ...
    async roleInfo () {
      ...
      if (rolename.includes("分管领导") || rolename.includes("政治部")) {
        this.role = false
      } else {
        this.role = true
      }

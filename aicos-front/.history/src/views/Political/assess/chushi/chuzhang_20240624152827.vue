    ...
    <HuilanDialog :title="dataMagFormTitle" :fullscreen="true" append-to-body :before-close="dataMagFormClose"
      ...
      <div class="dataMagFormBody" v-if="verifyTab == 'VIEW'">
        <div class="CMF_MAIN">
          ...
          <div class="CMF_BODY">
            <avue-form id="dataMagFormView" ref="dataMagFormRef" v-model="form2" :option="option2" v-if="tabType == 'TODO' && rolefinal == 3">
            </avue-form>
            <avue-form id="dataMagFormView" ref="dataMagFormRef" v-model="form3" :option="option2" v-if="tabType == 'TODO' && rolefinal == 3">
            </avue-form>

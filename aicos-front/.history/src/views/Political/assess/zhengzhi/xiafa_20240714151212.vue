  ...
  <basic-container>
    <avue-crud :option="option" :table-loading="loading" :data="data" :page="page" :permission="permissionList"
      ...
      <template v-slot:menu="scope">
        ...
        <el-button type="text" size="small" v-if="permissionList.yueBtn && scope.row.fabzt == 0" @click="comFormMagYue(scope.row)">生成余额
        </el-button>
        <el-button type="text" size="small" v-if="permissionList.jiaBtn && scope.row.fabzt == 0" @click="comFormMagJia(scope.row)">生成明细
        </el-button>
    ...
    <HuilanDialog :title="yueTitle" :fullscreen="true" width="80%" append-to-body :visible.sync="yueDetail" @close="yueClose">
      <avue-crud :option="optionyue" :table-loading="loadingyue" :data="datayue" :page="pageyue" :permission="permissionList"
        ...
        <template v-slot:menu="scope">
          <el-button type="text" size="small" v-if="permissionList.yueviewBtn" @click="yueView(scope.row,scope.index)">查看
          </el-button>
          <el-button type="text" size="small" v-if="permissionList.yueeditBtn" @click="yueUpdate(scope.row,scope.index)">编辑
          </el-button>
        </template>
      </avue-crud>

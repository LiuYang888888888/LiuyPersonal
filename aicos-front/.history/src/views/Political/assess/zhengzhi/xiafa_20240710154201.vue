      ...
      <div style="width: 100%;padding:10px">
        <table align="center" width="100%" class="table xunw_table_form" border="1">
          ...
          <tr>
            ...
            <td colspan="2">（签名）{{form1.qianm}}</td>
            <td colspan="2">日期：{{form1.pingjrq}}</td>
          </tr>
          <tr>
            <td >政治部审定</td>
            <td >{{ form1.zhengzbsd }}</td>
            <td colspan="2" style="text-align: left">（签章）</td>
            <td colspan="2" style="text-align: left;margin-left: 20px;">日期：{{ form1.zhengzbsdrq }}</td>
          </tr>
        </table>

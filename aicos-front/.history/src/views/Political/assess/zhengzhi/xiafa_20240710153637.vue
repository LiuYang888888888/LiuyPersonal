    ...
    <HuilanDialog :title="csTitle" :fullscreen="true" width="80%" append-to-body :visible.sync="chushiDetail">
      ...
      <div style="width: 100%;padding:10px">
        <table align="center" width="100%" class="table xunw_table_form" border="1">
          ...
          <tr>
            <td>考核指标</td>
            <td colspan="3">评价要素</td>
            <td colspan="2">考核结果</td>
          </tr>
          <tr>
            <td>政治品质</td>
            <td colspan="3">讲政治，具有较强的政治意识、大局意识、核心意识、看齐意识，认真贯彻执行党的路线、方针、政策。</td>
            <td colspan="2" v-if="form1.zhengzpz == 0">好</td>
            <td colspan="2" v-if="form1.zhengzpz == 1">较好</td>
            <td colspan="2" v-if="form1.zhengzpz == 2">一般</td>
            <td colspan="2" v-if="form1.zhengzpz == 3">较差</td>
          </tr>
          <tr>
            <td>职业道德</td>
            <td colspan="3">忠于职守，服从命令，精通业务，勤勉敬业，遵守公务员职业道德，依法执行公务。</td>
            <td colspan="2" v-if="form1.zhiydd == 0">好</td>
            <td colspan="2" v-if="form1.zhiydd == 1">较好</td>
            <td colspan="2" v-if="form1.zhiydd == 2">一般</td>
            <td colspan="2" v-if="form1.zhiydd == 3">较差</td>
          </tr>
          <tr>
            <td>工作作风</td>
            <td colspan="3">热爱本职工作，敢于担当，积极主动，尽职尽责，求真务实，深入基层，服务企业。</td>
            <td colspan="2" v-if="form1.gongzzf == 0">好</td>
            <td colspan="2" v-if="form1.gongzzf == 1">较好</td>
            <td colspan="2" v-if="form1.gongzzf == 2">一般</td>
            <td colspan="2" v-if="form1.gongzzf == 3">较差</td>
          </tr>
          <tr>
            <td>廉洁自律</td>
            <td colspan="3">严格遵守《廉政准则》、中央八项规定、省委省政府20条意见，无不正之风或违纪违规现象。</td>
            <td colspan="2" v-if="form1.lianjzl == 0">好</td>
            <td colspan="2" v-if="form1.lianjzl == 1">较好</td>
            <td colspan="2" v-if="form1.lianjzl == 2">一般</td>
            <td colspan="2" v-if="form1.lianjzl == 3">较差</td>
          </tr>
          <tr>
            <td>个性指标</td>
            <td colspan="3">工作数量、质量、效率以及所产生的效益和业务能力等。</td>
            <td colspan="2" v-if="form1.gexzb == 0">好</td>
            <td colspan="2" v-if="form1.gexzb == 1">较好</td>
            <td colspan="2" v-if="form1.gexzb == 2">一般</td>
            <td colspan="2" v-if="form1.gexzb == 3">较差</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td rowspan="2" v-if="form1.zhugldpj == 0">好</td>
            <td rowspan="2" v-if="form1.zhugldpj == 1">较好</td>
            <td rowspan="2" v-if="form1.zhugldpj == 2">一般</td>
            <td rowspan="2" v-if="form1.zhugldpj == 3">较差</td>
            <td rowspan="2">（签名）</td>
            <td rowspan="2">{{form1.qianm}}</td>
            <td rowspan="2">日期：</td>
            <td rowspan="2">{{form1.pingjrq}}</td>
          </tr>
          <tr>
          </tr>
          <tr>
            <td rowspan="2">政治部审定</td>
            <td rowspan="2">{{ form1.zhengzbsd }}</td>
            <td rowspan="2">（签章）</td>
            <td rowspan="2"></td>
            <td rowspan="2">日期：</td>
            <td rowspan="2">{{ form1.zhengzbsdrq }}</td>
          </tr>
          <tr>
          </tr>
        </table>

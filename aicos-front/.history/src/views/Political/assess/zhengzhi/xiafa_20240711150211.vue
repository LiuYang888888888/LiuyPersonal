  ...
  <basic-container>
    <avue-crud :option="option" :table-loading="loading" :data="data" :page="page" :permission="permissionList"
      ...
      <template v-slot:menu="scope">
        ...
        <el-button type="text" size="small" v-if="permissionList.yueBtn" @click="comFormYue(scope.row)">余额
        </el-button>
    ...
    <HuilanDialog :title="yueTitle" :fullscreen="true" width="80%" append-to-body :visible.sync="yueDetail" @close="yueClose">
      ...
      :before-open="beforeOpenyue" v-model="formyue" ref="crudyue"
      @current-change="currentChangeyue" @size-change="sizeChangeyue" @on-load="onLoadMx">
        <template v-slot:menu="scope">
          <el-button type="text" size="small" @click="mingxihzDetail(scope.row)">查看
          </el-button>
          <el-button type="text" size="small" @click="mingxihzDetail(scope.row)">编辑
          </el-button>
        </template>
      </avue-crud>
    </HuilanDialog>

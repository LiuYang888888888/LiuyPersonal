...
import {getInfo,getNotice,saveNotice,removeNotice,saveNoticeDetail,getNoticeDetail,saveNoticeDetailList,updateNotice,sendNotice} from "@/api/Political/common";
export default {
  data () {
    return {
      kaoqinTitle: '下发通知',

  ...
  <basic-container>
    <avue-crud :option="option" :table-loading="loading" :data="data" :page="page" :permission="permissionList"
      ...
      <template v-slot:menu="scope">
        <el-button type="text" size="small" v-if="permissionList.jiaBtn" @click="comFormMagDetail(scope.row)">详情
        </el-button>
        <el-button type="text" size="small" v-if="permissionList.jiaBtn" @click="comFormMagJia(scope.row)">生成
        </el-button>
        <el-button type="text" size="small" v-if="permissionList.jiaBtn" @click="handleEdit(scope.row)">编辑
        </el-button>
        <el-button type="text" size="small" v-if="permissionList.jiaBtn" @click="handleXiafa(scope.row)">下发
        </el-button>
        <el-button type="text" size="small" v-if="permissionList.jiaBtn" @click="handledel(scope.row)">删除
        </el-button>
        <el-button type="text" size="small" v-if="permissionList.jiaBtn" @click="handleHuizong(scope.row)">各部门汇总明细
        </el-button>
        <el-button type="text" size="small"  v-if="permissionList.jiaBtn" @click="handleMingxi(scope.row)">明细下载
        </el-button>
      </template>
    </avue-crud>

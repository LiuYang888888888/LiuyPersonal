<template>
  <basic-container>
    ...
    <HuilanDialog :title="kaoqinTitle" :fullscreen="true" width="90%" append-to-body :visible.sync="kaoqinTag">
      ...
      <div class="footer">
        <el-button type="primary" plain @click="savekq" v-if="editid">保存</el-button>
...
import {getNotice,saveNotice,saveNoticeDetail,getNoticeDetail,saveNoticeDetailList} from "@/api/Political/common";
export default {
  data () {
    return {
      kaoqinTitle: '下发通知',
  ...
  methods: {
    ...
    //保存
    savekq () {
      saveNoticeDetailList(this.tableData)

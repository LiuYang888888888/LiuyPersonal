  ...
  <basic-container>
    ...
    >
      <avue-crud :option="optionYear" :table-loading="loadingYear" :data="dataYear" :page="pageYear" :permission="permissionList"
        v-model="formYear" ref="crudYear" @search-change="searchChangeYear" @search-reset="searchResetYear" @selection-change="selectionChange"
        @current-change="currentChange" @size-change="sizeChange" @on-load="onLoad" v-if="yearShow">

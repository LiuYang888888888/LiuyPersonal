  ...
  <div class="newCss">
    ...
    >
      <div class="kqtitle">
        ...
        <el-input v-model="kqtitle" placeholder="请输入标题内容" disabled=""></el-input>
      </div>
      <div class="listadd"><el-button type="primary" @click="kqadd()">新增</el-button></div>
      <el-table
        :data="tableData"
        height="300"
        border
      ...
      <div class="footer">
        <el-button type="primary" plain @click="savekq">保存</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      kaoqinTag:false,
      kqtitle:'',
      tableData:[{i:0,chushi:'秘书处',month:'',khnum:'',goodnum:'',beizhu:'',editid:true}],
      formVerify: false,
      tabType: "ALL",
      formVerifyText: "",
      verifyTab: "VIEW",

  ...
  <basic-container>
    <avue-crud :option="listOption" :table-loading="loading" :data="listData" ref="listRef" v-model="listForm"
      ...
      <template #danwlx="scope">
        <el-tag v-if="scope.row.danwlx == 1" type="" effect="dark" color="#67C23A" hit="false">企业单位</el-tag>
        <el-tag v-if="scope.row.danwlx == 2" type="" effect="dark" color="#af2c30" hit="false">政府单位</el-tag>
      </template>

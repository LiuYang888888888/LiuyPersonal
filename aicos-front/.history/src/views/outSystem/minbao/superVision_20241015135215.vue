  ...
  <basic-container>
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane name="all">
        <span slot="label"><i class="el-icon-s-management"></i> 全部</span>
      </el-tab-pane>
      <el-tab-pane name="qiye">
        <span slot="label"><i class="el-icon-s-management"></i> 企业单位</span>
      </el-tab-pane>
      <el-tab-pane name="zhengfu">
        <span slot="label"><i class="el-icon-s-management"></i> 政府单位</span>
      </el-tab-pane>
    </el-tabs>

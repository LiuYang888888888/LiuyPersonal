  ...
  <basic-container>
    <avue-crud :option="listOption" :table-loading="loading" :data="listData" ref="listRef" v-model="listForm"
      ...
      <template #danwlx="scope">
        <el-tag v-if="scope.row.danwlx == 1" type="danger" effect="dark" color="#af2c30">企业单位</el-tag>
        <el-tag v-if="scope.row.danwlx == 2" type="danger" effect="dark" color="#af2c30">政府单位</el-tag>
      </template>

...
export default {
    ...
    permissionList () {
      return {
        excelBtn: this.vaildData(
          this.permission[`outsys-emer-excelBtn`],
          false
        ),
        addBtn: this.vaildData(
          this.permission[`outsys-emer-add`],
          false
        ),
        viewBtn: this.vaildData(
          this.permission[`outsys-emer-view`],
          false
        ),
        editBtn: this.vaildData(
          this.permission[`outsys-emer-edit`],
          false
        ),
        delBtn: this.vaildData(
          this.permission[`outsys-emer-del`],
          false
        ),
        tijiaoBtn: this.vaildData(
          this.permission[`outsys-emer-tijiao`],
          false
        ),
        shenheBtn: this.vaildData(
          this.permission[`outsys-emer-shenhe`],
          false
        ),
        //导入
        uploadBtn: this.vaildData(
          this.permission[`outsys-emer-armyUploadBtn`],
          false
        ),
        // 模版下载
        downloadExcel: this.vaildData(
          this.permission["outsys-emer-download"],
          false
        ),
        // 导出
  ...
  methods: {
    ...
    onLoad (page /*, params = {}*/) {
      this.loading = true;
      if (this.query.xingzqy && Array.isArray(this.query.xingzqy)) {
        this.query.xingzqy = this.query.xingzqy.join("/")
      }
      const dataParam = {

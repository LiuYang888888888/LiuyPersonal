  ...
  <basic-container>
    <avue-crud :option="listOption" :table-loading="loading" :data="listData" ref="listRef" v-model="listForm"
      ...
      <template slot-scope="scope" slot="menuLeft">
        ...
        <el-upload v-if="permissionList.uploadBtn" :auto-upload="false"
...
export default {
    ...
    permissionList () {
      return {
        excelBtn: this.vaildData(
          this.permission[`outsys-safe-excelBtn`],
          false
        ),
        addBtn: this.vaildData(
          this.permission[`outsys-safe-add`],
          false
        ),
        viewBtn: this.vaildData(
          this.permission[`outsys-safe-view`],
          false
        ),
        editBtn: this.vaildData(
          this.permission[`outsys-safe-edit`],
          false
        ),
        delBtn: this.vaildData(
          this.permission[`outsys-safe-del`],
          false
        ),
        tijiaoBtn: this.vaildData(
          this.permission[`outsys-safe-tijiao`],
          false
        ),
        shenheBtn: this.vaildData(
          this.permission[`outsys-safe-shenhe`],
          false
        ),
        //导入
        uploadBtn: this.vaildData(
          this.permission[`outsys-safe-armyUploadBtn`],
          false
        ),
        // 模版下载
        downloadExcel: this.vaildData(
          this.permission["outsys-safe-download"],
          false
        ),
        // 导出
  ...
  methods: {
    ...
    rowSave (row, done, loading) {
      if(row.zhaop.length > 0){
        row.zhaop = row.zhaop[0].value
      }

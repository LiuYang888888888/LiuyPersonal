<template>
  <basic-container>
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane name="qiye">
        <span slot="label"> 企业单位</span>
      </el-tab-pane>
      <el-tab-pane name="zhengfu">
        <span slot="label"> 政府单位</span>
      </el-tab-pane>
    </el-tabs>
...
export default {
  ...
  methods: {
    ...
    searchReset () {
      if(this.activeName == 'qiye'){
        this.query = {danwlx:'1'};
      }else if(this.activeName == 'zhengfu'){
        this.query = {danwlx:'2'};        
      }else {
        this.query = {};
      }
    ...
    selectionClear () {
      if(this.$route.query.type){
        if(this.$route.query.type == 'add' && this.permissionList.outsys-supervision-add){
    ...
    handleClick(){
      if(this.activeName == 'all'){
        if(this.query.danwlx){
          this.$delete(this.query,'danwlx')
        } 

...
import {} from "@/api/outSystem/mbCompany";
...
export default {
  ...
  created(){
    this.$refs.pies.getPie()
    this.$refs.lines.getLine()
  },
  methods:{
    // 指定范围内，指定个数，无重复的随机整数
    ...
    chooseInfo(data){
      ...
      let linearr = []
      this.areaNum.forEach(e =>{
        let num = this.getRandomNumber(1,1,20)
        e = e + num[0]
        linearr.push(e)
      })
      this.areaNum = linearr

  ...
  <div class="sysIndex">
    ...
    <div class="sysIndexBottom">
      ...
      <div class="sysIndexBottomRight">
        <lineshow v-if="piedata.length > 0" :lineTitle="lineTitle" :areaData="areaData" :areaNum="areaNum" ref="lines"></lineshow>
      </div>
    </div>
  ...
  methods:{
    ...
    chooseInfo(data){
      ...
      if(data == '企业信息'){
        ...
        this.areaData = this.areaData2
        this.areaNum = this.areaNum2
      }
      if(data == '应急体系'){
        this.pieTitle = '类型',
        this.piedata = this.piedata3
        this.areaData = this.areaData3
        this.areaNum = this.areaNum3
      }
      
      if(data == '安全管理人员考核'){
        this.pieTitle = '职称',
        this.piedata = this.piedata4
        this.areaData = this.areaData4
        this.areaNum = this.areaNum4
      }
      if(data == '文件收发管理'){
        this.pieTitle = '单位类型',
        this.piedata = this.piedata5
        this.areaData = this.areaData5
        this.areaNum = this.areaNum5
      }
      
      if(data == '安全管理先进申报'){
        this.pieTitle = '营收情况',
        this.piedata = this.piedata6
        this.areaData = this.areaData6
        this.areaNum = this.areaNum6
      }
      
      if(data == '安全生产许可年检'){
        this.pieTitle = '许可证期限',
        this.piedata = this.piedata7
        this.areaData = this.areaData7
        this.areaNum = this.areaNum7
      }
      
      if(data == '销售许可年检'){
        this.pieTitle = '注册类型',
        this.piedata = this.piedata8
        this.areaData = this.areaData8
        this.areaNum = this.areaNum8
      }
    }
  }
}

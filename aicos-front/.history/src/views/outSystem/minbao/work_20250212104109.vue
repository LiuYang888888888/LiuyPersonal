<template>
  <div class="sysIndex">
    ...
    <div class="sysIndexBottom">
      <div :class="[{'sysIndexBottomLeft':piedata.length > 0 && areaData.length == 0}, {'hasData': areaData.length > 0 && piedata.length > 0}]">
        <pie v-if="piedata.length > 0" :pieTitle="pieTitle" :piedata="piedata" ref="pies"></pie>
      </div>
      <div :class="[{'sysIndexBottomRight':areaData.length > 0 && piedata.length == 0}, {'hasData': areaData.length > 0 && piedata.length > 0}]">

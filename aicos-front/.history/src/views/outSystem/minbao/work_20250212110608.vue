<template>
  <div class="sysIndex">
    ...
    <div class="sysIndexBottom">
      <div v-show="piedata.length > 0" :class="{
        'sysIndexBottomLeft': true,
        'hasData': piedata.length > 0 && areaData.length > 0,
        'fullWidth': (piedata.length > 0 && areaData.length === 0)
      }">
        <pie  :pieTitle="pieTitle" :piedata="piedata" ref="pieRef"></pie>
      </div>
      <div v-show="areaData.length > 0" :class="{
        'sysIndexBottomRight': true,
        'hasData': piedata.length > 0 && areaData.length > 0,
        'fullWidth': (areaData.length > 0 && piedata.length === 0)
      }">
        <lineshow  :lineTitle="lineTitle" :areaData="areaData" :areaNum="areaNum" ref="lineRef"></lineshow>
      </div>
    </div>

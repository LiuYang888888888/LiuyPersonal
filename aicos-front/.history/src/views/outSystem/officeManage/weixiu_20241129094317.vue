<template>
  <basic-container>
    ...
    <HuilanDialog :title="appTitle" :fullscreen="false" append-to-body :before-close="appClose"
      ...
      <div style="max-height: 300px;overflow: auto;margin: 20px auto;" v-if="showSuret">
...
export default {
  ...
  methods: {
    ...
    async comFormMagView (row) {
      ...
      this.form.lianxr = dataRes.lianxr
      this.form.lianxdh = dataRes.lianxdh
    ...
    saveList(){
      ...
      const dataParam = {
        ...
        lianxr:this.form.lianxr,
        lianxdh:this.form.lianxdh,
        leix:'3',

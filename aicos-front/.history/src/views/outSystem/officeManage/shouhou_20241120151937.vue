    ...
    permissionList () {
      return {
        addBtn: this.vaildData(
          this.permission[`outsys-storage-add`],
          false
        ),
        viewBtn: this.vaildData(
          this.permission[`outsys-storage-view`],
          false
        ),
        editBtn: this.vaildData(
          this.permission[`outsys-storage-edit`],
          false
        ),
        delBtn: this.vaildData(
          this.permission[`outsys-storage-del`],
          false
        ),
      };
    },
...
/outSystem/officeManage/application
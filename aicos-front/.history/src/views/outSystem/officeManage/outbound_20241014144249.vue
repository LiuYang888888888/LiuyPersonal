    ...
    permissionList () {
      return {
        addBtn: this.vaildData(
          this.permission[`outsys-outbound-add`],
          false
        ),
        viewBtn: this.vaildData(
          this.permission[`outsys-outbound-view`],
          false
        ),
        editBtn: this.vaildData(
          this.permission[`outsys-outbound-edit`],
          false
        ),
        delBtn: this.vaildData(
          this.permission[`outsys-outbound-del`],
          false
        ),
      };
    },

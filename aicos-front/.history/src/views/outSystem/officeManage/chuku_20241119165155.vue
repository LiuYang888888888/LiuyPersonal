<template>
  <basic-container>
    <avue-crud id="printTest" :option="listOption" :table-loading="loading" :data="listData" ref="listRef" v-model="listForm"
      ...
      <template slot="menuLeft">
        ...
        <el-button size="small" type="primary" v-print="'#printTest'">打印</el-button>
      </template>

...
export default {
  data () {
    var dianzyx = (rule,value,callback) => {
      //验证邮箱的正则表达式
        ...
        column: [
          ...
          },
          {
            ...
            rules: [
              ...
              {validator: dianzyx, message: '请输入合法的邮箱'}
            ],
    ...
    permissionList () {
      return {
        addBtn: this.vaildData(
          this.permission[`outsys-junkou-add`],
          false
        ),
        viewBtn: this.vaildData(
          this.permission[`outsys-junkou-view`],
          false
        ),
        editBtn: this.vaildData(
          this.permission[`outsys-junkou-edit`],
          false
        ),
        delBtn: this.vaildData(
          this.permission[`outsys-junkou-del`],
          false
        ),
        tijiaoBtn: this.vaildData(
          this.permission[`outsys-junkou-tijiao`],
          false
        ),
        shenheBtn: this.vaildData(
          this.permission[`outsys-junkou-shenhe`],
          false
        ),
        // 导出
        exportExcel: this.vaildData(
          this.permission["sys-junkou-export"],
          false
        ),
      };
    },

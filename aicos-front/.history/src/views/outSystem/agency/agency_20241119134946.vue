...
export default {
        ...
        column: [
          ...
          },
          {
            ...
            rules: [
              ...
              {validator: youx, message: '请输入合法的邮箱'}
            ],
          ...
          },
          {
            ...
            rules: [
              ...
              {validator: dianh, message: '请输入正确的手机号'}
            ],
  ...
  methods: {
    ...
    dataMagVerifyNo(){
     ...
     () {
      this.formVerifyText = ''
     dataMagFormClose this.dataMagFormTag = false;
    },
  }
};
</script>

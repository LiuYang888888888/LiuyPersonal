  ...
  <div class="sysIndex">
    ...
    <div class="sysIndexBottom">
      <div class="sysIndexBottomLeft">
        <pie v-if="isValidData(piedata)" :pieTitle="$t('pieTitle')" :piedata="piedata"></pie>
      </div>
      <div class="sysIndexBottomRight">
        <lineshow v-if="isValidData(areaNum)" :lineTitle="$t('lineTitle')" :areaData="areaData" :areaNum="areaNum"></lineshow>
      </div>
    </div>
  </div>
</template>

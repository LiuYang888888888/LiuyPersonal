  ...
  <basic-container>
    ...
    <avue-crud :option="listOption" :table-loading="loading" :data="listData" ref="listRef" v-model="listForm"
      ...
      <template v-slot:menu="scope">
        ...
        <el-button type="text" size="small"  v-if="(scope.row.zhuangt == 1 || scope.row.shenhzt == 3) && permissionList.editBtn" @click="comFormMagUpdate(scope.row)">编辑
        </el-button>
        <el-button type="text" size="small" v-if="(scope.row.zhuangt == 1 || scope.row.shenhzt == 3) && permissionList.tijiaoBtn" @click="comFormTijiao(scope.row)">提交
        </el-button>

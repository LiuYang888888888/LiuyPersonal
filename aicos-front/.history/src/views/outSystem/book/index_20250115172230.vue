        ...
        <div class="right-center">
          <div class="user-box" v-for="(item, index) in userList" :key="index">
            <div class="user-avatar">
              ...
              <div class="job">
                <div class="name">{{ item.loginName }}</div> 
                <div style="margin-left: 20px;" v-if="item.avatar">{{ item.extendField3 }}</div>
              </div>
            </div>
            <div class="user-info">
              <!-- <div class="info-box">
              ...
              <!-- <div class="info-box">
                ...
                <div class="info-type">职务</div>
                <div class="info-content">：{{ item.tel }}</div>
              </div> -->
            </div>
          </div>
        </div>

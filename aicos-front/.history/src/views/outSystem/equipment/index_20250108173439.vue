<template>
  <HuilanBasic>
    ...
    <HuilanDialog :title="shareTitle" :fullscreen="false" append-to-body :before-close="shareClose"
      ...
      <avue-form id="dataMagFormView" ref="dataMagFormRef" v-model="formshare" :option="option" v-if="showform" @submit="handleSubmit">
      </avue-form>
    </HuilanDialog>
  </HuilanBasic>
...
import {add, update, remove, getList, submit,disagree,complete, exportExcel, importExcel, importTemplateFile, getById,  getEnterList} from "@/api/outSystem/equipment";

    ...
    <div class="armyList">
      <avue-crud :option="option" :table-loading="loading" :data="data" :page="page" :permission="permissionList"
        ...
        <template slot-scope="scope" slot="menuLeft">
          <el-button v-if="permissionList.exportExcel && tabType =='ALL'" size="small" icon="el-icon-download" type="primary" @click="exportExcel">
            导出
          </el-button>
          ...
          <el-button v-if="permissionList.addBtn" size="small" icon="el-icon-plus" type="primary" @click="handleAdd">新增</el-button>
        </template>
...
import {add, update, remove, getList, submit,disagree,complete, exportExcel, importExcel, importTemplateFile, getById} from "@/api/outSystem/equipment";

  ...
  <div class="sysIndex">
    ...
    <div class="sysIndexBottom">
      <div class="sysIndexBottomCon">
        <lineslot :areaData="areaData" :areaNum="areaNum">
          <template v-slot:header>
            ...
            <div class="toolBoxHeader">
              <div class="toolBoxTitle">用车总统计</div>
              <div class="toolBoxRadio">
                <el-radio-group v-model="time" @input="change">
                  <el-radio-button label="公车">今日</el-radio-button>
                  <el-radio-button label="社会用车">本周</el-radio-button>
                  <el-radio-button label="社会用车">本月</el-radio-button>
                </el-radio-group>
              </div>
            </div>
          </template>

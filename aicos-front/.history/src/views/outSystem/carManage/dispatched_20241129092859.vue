...
export default {
    ...
    permissionList () {
      return {
        toDoBtn: this.vaildData(
          this.permission[`outsys-dispatched-toDo`],
          false
        ),
        doneBtn: this.vaildData(
          this.permission[`outsys-dispatched-done`],
          false
        ),
        addBtn: this.vaildData(
          this.permission[`outsys-dispatched-add`],
          false
        ),
        viewBtn: this.vaildData(
          this.permission[`outsys-dispatched-view`],
          false
        ),
        editBtn: this.vaildData(
          this.permission[`outsys-dispatched-edit`],
          false
        ),
        delBtn: this.vaildData(
          this.permission[`outsys-dispatched-del`],
          false
        ),
        tijiaoBtn: this.vaildData(
          this.permission[`outsys-dispatched-tijiao`],
          false
        ),
        shenheBtn: this.vaildData(
          this.permission[`outsys-dispatched-shenhe`],
          false
        ),
        huancheBtn: this.vaildData(
          this.permission[`outsys-dispatched-huanche`],
          false
        ),
      };
    },
  ...
  methods: {
    ...
    async carDriverMethod(){
      ...
      const data = await getListDriver(dataParam);
      this.listOption.column[10].dicData = data.data.data.fieldList
    },
    tabChange () {
      this.query = {};

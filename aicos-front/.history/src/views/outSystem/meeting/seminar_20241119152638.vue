    ...
    onSubmit() {
      this.$refs.informationForm.validate((valid) => {
        if (valid) {
          ...
          params.append("meetingName", this.form.meetingName);
          params.append("meetingAddress", this.form.meetingAddress);
          params.append("meetingStartTime", this.form.meetingStartTime);
          params.append("meetingEndTime",this.form.meetingEndTime);
        }
      })
    },
    //删除

<template>
  <basic-container>
    ...
    <avue-crud :option="listOption" :table-loading="loading" :data="listData" ref="listRef" v-model="listForm"
      ...
      <template slot="cheltp" slot-scope="scope">
        <div class="xuqmcName">
          <img :src="cheltp" style="width: 5rem;height: auto;" />
        </div>
      </template>
...
export default {
  data () {
    ...
    return {
      ...
      cheltp:'https://img3.bitautoimg.com/autoalbum/files/20210916/683/202109161202.JPG',

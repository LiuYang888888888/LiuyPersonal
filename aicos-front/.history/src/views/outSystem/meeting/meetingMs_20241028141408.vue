...
import {
  ...
  viewListData,
  getListDataMeet
} from "@/api/outSystem/meetingApplyMs";
import {
  getListDataMeetUse
    ...
    permissionList () {
      return {
        addBtn: this.vaildData(
          this.permission[`outsys-meetapplyMs-add`],
          false
        ),
        viewBtn: this.vaildData(
          this.permission[`outsys-meetapplyMs-view`],
          false
        ),
        editBtn: this.vaildData(
          this.permission[`outsys-meetapplyMs-edit`],
          false
        ),
        delBtn: this.vaildData(
          this.permission[`outsys-meetapplyMs-del`],
          false
        ),
      };
    },

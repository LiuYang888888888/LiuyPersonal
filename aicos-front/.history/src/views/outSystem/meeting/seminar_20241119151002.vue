  ...
  <basic-container>
    <avue-crud :option="listOption" :table-loading="loading" :data="listData" ref="listRef" v-model="listForm"
      ...
      <template v-slot:menu="scope">
        ...
        <el-button type="text" size="small" v-if="permissionList.tjBtn" @click="comFormMagtj(scope.row)">提交
        </el-button>
        <el-button type="text" size="small" v-if="permissionList.tzBtn" @click="comFormMagtz(scope.row)">通知
        </el-button>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="会议标题：" prop="huiybt">
              <el-input  placeholder="请输入会议标题" v-model="form.huiybt"/>
            </el-form-item>
          </el-col>
        
          <el-col :span="24">
            <el-form-item label="会议内容：" prop="huiynr">
              <Editor :value="form.huiynr" @input="getContentnr"></Editor>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="会议要求：" prop="huiyyq"></el-form-item>
              <Editor :value="form.huiyyq" @input="getContentyq"></Editor>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="参会人数：" prop="canhrs">
              <el-input  placeholder="请输入参会人数" v-model="form.canhrs"/>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="会议开始时间：" prop="huiykssj">
              <el-date-picker
                v-model="form.huiykssj"
                type="datetime"
                placeholder="选择日期时间"
          ...
          <el-col :span="24">
            <el-form-item label="会议结束时间：" prop="huiyjssj">
              <el-date-picker
                v-model="form.huiyjssj"
                type="datetime"
                placeholder="选择日期时间"
                value-format="yyyy-MM-dd HH:mm:ss"
                format="yyyy-MM-dd HH:mm:ss"
          ...
          <el-col :span="24">
            <el-form-item label="申请人：" prop="shenqr">
              <el-input  placeholder="请输入申请人"  v-model="form.shenqr"/>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="申请部门：" prop="shenqbm">
              <el-input  placeholder="请输入申请部门" v-model="form.shenqbm"/>
            </el-form-item>
          </el-col>
          <el-col :span="24">

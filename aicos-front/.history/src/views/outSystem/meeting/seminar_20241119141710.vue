  ...
  <basic-container>
    ...
    <HuilanDialog :title="dataMagFormTitle" :fullscreen="false" append-to-body :before-close="dataMagFormClose"
      ...
      <el-form ref="form" :model="form" label-width="80px">
        <el-row>
          <el-col :span="24">
            <el-form-item label="会议标题" prop="">
              <el-input  placeholder="请输入会议标题" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="会议内容" prop="">
              <Editor></Editor>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="会议要求" prop="">
              <Editor></Editor>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="参会人数" prop="">
              <el-input  placeholder="请输入参会人数" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="会议开始时间" prop="">
              <el-date-picker
          ...
          <el-col :span="24">
            <el-form-item label="会议结束时间" prop="">
              <el-date-picker
                v-model="form.huiyjssj"
                type="datetime"
                placeholder="选择日期时间"
          ...
          <el-col :span="24">
            <el-form-item label="会议地点" prop="">
              <el-input  placeholder="请输入会议地点" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>

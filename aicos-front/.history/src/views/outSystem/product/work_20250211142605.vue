  ...
  <div class="sysIndex">
    ...
    <div class="sysIndexBottom">
      ...
      <div class="sysIndexBottomRight">
        <lineshow v-if="areaData.length > 0" :lineTitle="lineTitle" :areaData="areaData" :areaNum="areaNum" :seriesList="seriesList" :legendList="legendList" :colorList="colorList"></lineshow>
      </div>
    </div>
        ...
        res.data.data.forEach(item => {
          ...
          if (item.type_ == '32') {
            ...
            if (typearr2.length > 0 && typearr2[1] && typearr2[0] == '河南省') {
              ...
              //   }
              // })
              if (this.areaData.includes(elementToFind)) {

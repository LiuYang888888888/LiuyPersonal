  ...
  <div class="sysIndex">
    ...
    <div class="sysIndexBottom">
      ...
      <div class="sysIndexBottomRight">
        <lineshow v-if="piedata.length > 0" :lineTitle="lineTitle" :areaData="areaData" :areaNum="areaNum" :seriesList="seriesList" :legendList="legendList" :colorList="colorList"></lineshow>
      </div>
    </div>

    ...
    <div class="armyList">
      ...
      >
        ...
        <div class="shfooter">
          ...
          <el-button icon="el-icon-circle-close" @click="dataMagFormClose">取 消</el-button>
        </div>
      </HuilanDialog>
...
import {add, update, remove, getList, submit, disagree, complete, getById, exportExcel} from "@/api/outSystemProduct/common";
    ...
    permissionList() {
      return {
        ...
        exportExcel: this.vaildData(
          this.permission["sys-porduct-jyexport"],
          false
        ),
      };
    },

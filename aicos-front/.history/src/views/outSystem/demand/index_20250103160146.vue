    ...
    <div class="armyList">
      <avue-crud :option="option" :table-loading="loading" :data="data" :page="page" :permission="permissionList"
        ...
        <template v-slot:menu="scope">
          ...
          <el-button type="text" size="small" v-if="permissionList.updateBtn && scope.row.zhuangt==='2'"
    ...
    permissionList() {
      return {
        ...
        uploadBtn: this.vaildData(
          this.permission[`demand-user-uploadBtn`],
          false
        ),
        // 审核
        ...
        exportExcel: this.vaildData(
          this.permission["demand-user-export"],
          false
        ),
      };
    },

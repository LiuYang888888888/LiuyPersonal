    ...
    <avue-crud :option="option"
      ...
      <template slot="menuLeft">
        <el-button type="primary"
                   size="small"
                   v-if="permission.projectmanage_zt"
                   plain
      ...
      <template slot-scope="scope" slot="menu">
        <!-- <el-button type="text"
          size="small"
          v-if="permission.projectmanage_reminders"
          plain
          class="none-border"
          icon="el-icon-bell"
          >催办
        ...
        <el-button type="text"
          size="small"
          v-if="permission.projectmanage_start"
          plain
          class="none-border"
          icon="el-icon-check"
        ...
        <el-button type="text"
          size="small"
          v-if="permission.projectmanage_manage"
          plain
          class="none-border"
          icon="el-icon-setting"
          @click.stop="handSetting(scope.row)"
         >配置项管理
        </el-button>

        <el-button type="text"
          size="small"
          v-if="permission.projectmanage_manageview"
          plain
          class="none-border"
          icon="el-icon-view"
          @click.stop="handSettingview(scope.row)"
         >查看配置项
        </el-button>

        <el-button type="text"
          size="small"
          v-if="permission.projectmanage_approval && scope.row.projectStatus < 2"
          plain
          class="none-border"
        ...
        <el-button type="text"
          size="small"
          v-if="permission.projectmanage_defeat && scope.row.projectStatus < 2"
          plain
          class="none-border"
          icon="el-icon-circle-close"
          @click="defeatBtn(scope.row)"
          >驳回
        </el-button>

        <el-button type="text"
          size="small"
          v-if="permission.projectmanage_approvallist"
          plain
          class="none-border"
          icon="el-icon-tickets"
          @click="approvalList(scope.row)"
          >审阅记录
        </el-button>

        <el-button type="text"
          size="small"
          v-if="permission.project_supplement"
          plain
          class="none-border"
     ...
     <el-dialog title="项目补录" :visible.sync="dialogSummplent" :append-to-body="true" :center="true" width="90%">
      ...
      <div class="sup_content">
        <el-row type="flex" class="row-bg" v-for="(item,index) of summplentList" :key="index">
          ...
          <el-col :span="6">
            <div class="sup_main">
              <div class="title">固定投资:</div><el-input v-model="item.fixedInvestment" placeholder="请输入内容"></el-input><div class="final">万元</div>
            </div>
          </el-col>
          <el-col :span="6">
          <div class="sup_main">
              <div class="title">流动投资:</div><el-input v-model="item.currentInvestment" placeholder="请输入内容"></el-input><div class="final">万元</div>
            </div>
          </el-col>
        </el-row>
      </div>
...
<script>
  import {deleteimg , listsup , savesup , getList, getDetail, add, update, remove , approvaladd , approvalDetail , approvalList , zt} from "@/api/project_manage/projectmanage";
  import {getStageList} from "@/api/project_stage_config/stageconfig";

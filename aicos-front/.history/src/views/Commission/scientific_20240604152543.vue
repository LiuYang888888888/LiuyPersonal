...
export default {
  ...
  computed: {
    ...
    permissionList () {
      return {
        xingshiBtn: this.vaildData(
          this.permission[`sys-commonForm-dataMag-xingshi`],
          false
        ),
        zhuanjiaBtn: this.vaildData(
          this.permission[`sys-commonForm-dataMag-zhuanjia`],
          false
        ),
        chushishenpiBtn: this.vaildData(
          this.permission[`sys-commonForm-dataMag-chushishenpi`],
          false
        ),
        banlingdaoBtn: this.vaildData(
          this.permission[`sys-commonForm-dataMag-banlingdao`],
          false
        ),
        guojiajuBtn: this.vaildData(
          this.permission[`sys-commonForm-dataMag-guojiaju`],
          false
        ),
      };
    },

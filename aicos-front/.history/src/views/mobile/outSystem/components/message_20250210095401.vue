      ...
      <van-popup v-model="item.show" position="bottom" v-if="item.type == 'checkbox'">
        ...
        <div class="selectall">
          <van-radio-group v-model="radio" direction="horizontal">
            <van-radio name="1" @click="selectAll">全选</van-radio>
            <van-radio name="2" @click="clearAll">取消全选</van-radio>
          </van-radio-group>
        </div>
...
export default {
  ...
  methods: {
    ...
    selectAll() {
      this.selectedUnits = this.filteredOptions.map(option => option.value);
    },
    clearAll() {
      this.selectedUnits = [];
    },

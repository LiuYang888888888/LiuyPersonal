    ...
    <van-pull-refresh v-model="refreshing" @refresh="onRefresh">
      ...
      >
        <van-swipe-cell v-for="item in list" :key="item" >
          ...
          <template #right>
            <van-button square type="danger" text="查看"  @click="comFormMagView(item)"/>
            <van-button square type="danger" text="编辑"  @click="comFormMagUpdate(item)"/>
            <van-button square type="danger" text="提交"  @click=""/>

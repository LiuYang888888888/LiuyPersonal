      ...
      >
        <van-cell-group inset>
          <van-swipe-cell v-for="item in list" :key="item" >
            <van-cell :border="false" :title="item.zizmc" v-if="item.zizmc"/>
            <template #right>
              ...
              <van-button square type="danger" text="下载"  v-if="permissionList.downloadBtn" @click="comFormDownload(item)"/>
    ...
    permissionList () {
      return {
        addBtn: this.vaildData(
          this.permission[`outsys-military-add`],
          false
        ),
        viewBtn: this.vaildData(
          this.permission[`outsys-military-view`],
          false
        ),
        editBtn: this.vaildData(
          this.permission[`outsys-military-edit`],
          false
        ),
        delBtn: this.vaildData(
          this.permission[`outsys-military-del`],
          false
        ),
        downloadBtn: this.vaildData(
          this.permission[`outsys-military-download`],
          false
        ),
      };
    },

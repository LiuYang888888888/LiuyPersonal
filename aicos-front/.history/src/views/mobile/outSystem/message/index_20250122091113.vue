        ...
        <van-cell-group inset>
          <van-swipe-cell v-for="item in list" :key="item" >
            ...
            <template #right>
              ...
              <van-button square type="danger" text="编辑"  v-if="permissionList.huifuBtn && !item.huifyh && !item.huifnr " @click="comFormMagUpdate(item)" style="border-right: 1px solid #fff;"/>
            </template>
          </van-swipe-cell>
        </van-cell-group>
      </van-list>

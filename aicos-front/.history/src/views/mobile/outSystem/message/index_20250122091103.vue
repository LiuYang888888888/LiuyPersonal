        ...
        <van-cell-group inset>
          <van-swipe-cell v-for="item in list" :key="item" >
            ...
            <template #right>
              ...
              <van-button square type="danger" text="编辑"  v-if="permissionList.huifuBtn &&!scope.row.huifyh && !scope.row.huifnr " @click="comFormMagUpdate(item)" style="border-right: 1px solid #fff;"/>
            </template>
          </van-swipe-cell>
        </van-cell-group>
      </van-list>
...
import {remove, getList, submit} from "@/api/outSystem/demand";

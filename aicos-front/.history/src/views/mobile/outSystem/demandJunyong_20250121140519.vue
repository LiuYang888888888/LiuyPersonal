        ...
        <van-cell-group inset>
          <van-swipe-cell v-for="item in list" :key="item" >
            ...
            <template #right>
              ...
              <van-button square type="danger" text="提交"  v-if="permissionList.submit && (scope.row.zhuangt == 1 || scope.row.zhuangt == 3)" @click="comFormTijiao(item)" style="border-right: 1px solid #fff;"/>

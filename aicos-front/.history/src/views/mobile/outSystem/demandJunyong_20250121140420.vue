        ...
        <van-cell-group inset>
          <van-swipe-cell v-for="item in list" :key="item" >
            ...
            <template #right>
              ...
              <van-button square type="danger" text="编辑"  v-if="permissionList.updateBtn && (item.zhuangt == 1 || scope.row.zhuangt == 3)" @click="comFormMagUpdate(item)" style="border-right: 1px solid #fff;"/>

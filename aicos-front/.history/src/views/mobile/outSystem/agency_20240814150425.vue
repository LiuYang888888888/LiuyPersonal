<template>
  <div>
    ...
    <div style="width: 100%;text-align: left;margin-bottom: 20px;border-bottom: 1px solid #af2c30;padding: 10px 10px;">
      <van-button color="#af2c30" size="small">新增</van-button>
    </div>

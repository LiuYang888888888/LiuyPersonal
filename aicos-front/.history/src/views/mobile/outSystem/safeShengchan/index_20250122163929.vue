<template>
  <div>
    ...
    <div style="text-align: left;margin-bottom: 20px;border-bottom: 1px solid #af2c30;padding: 10px;" v-if="permissionList.addBtn">
...
import {delListData, getListData, submitListData} from "@/api/outSystem/safeShengchan";

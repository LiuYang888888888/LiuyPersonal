        ...
        <van-cell-group inset>
          <van-swipe-cell v-for="item in list" :key="item" >
            ...
            <template #right>
              ...
              <van-button square type="danger" text="共享"  v-if="permissionList.shareBtn && (item.zhuangt == '' || item.zhuangt == '3')" @click="comFormTijiao(item)" style="border-right: 1px solid #fff;"/>

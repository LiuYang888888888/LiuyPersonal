  ...
  <HuilanBasic class="toolBox">
    ...
    <div class="cont-box">
      <div class="infoLi" v-for="(item, index) in infoList" :key="index">
        <p class="infoText" v-if="item.type_value == 'num1' || item.type_value == 'num4' || item.type_value == 'num11'">待审核</p>
        <p class="infoText" v-if="item.type_value == 'num2' || item.type_value == 'num5'">已驳回</p>
        <p class="infoText" v-if="item.type_value == 'num3' || item.type_value == 'num6'">已通过</p>

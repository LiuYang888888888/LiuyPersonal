...
export const remove = (params) => {
  return request({
    url: `${baseURL}api/aicos-second/member/TechnicalJZMProductInformation/delete`,
    method: 'post',
    data: params,
...
export const getById = (params) => {
  return request({
    url: `${baseURL}api/aicos-second/member/TechnicalJZMProductInformation/getById`,
    method: 'post',
    data: params,
  })
}
...
export const exportExcel = (row) => {
  return request({
    url: `${baseURL}api/aicos-second/member/TechnicalJZMProductInformation/exportExcel`,
    method: 'post',
    data: row
  })
}

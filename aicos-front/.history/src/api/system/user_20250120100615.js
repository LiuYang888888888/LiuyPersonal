...
export const getUserInfoPost = (data) => request({
  url: `${baseURL}api/aicos-second/member/getInfo`,
  method: 'post',
  data:data
});
...
export const resetPassword = (id) => {
  return request({
    url: `${baseURL}api/aicos-second/member/resetPassword`,
    method: 'post',
    data: {
      id,
    }
...
//重置密码用户
export const resetPasswordyh = (id) => {
  return request({
    url: `${baseURL}api/aicos-system/baseUser/resetPassword`,
    method: 'post',
    data: id
  })
}

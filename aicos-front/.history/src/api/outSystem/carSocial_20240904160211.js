...
export const auditNoListData = (form) => {
  return request({
    url: `${baseURL}api/aicos-second/msc/vehicleOfSocietyApplication/closeForDisagree`,
    method: 'post',
    data:form
  })
}
...
export const backListData = (row) => {
  return request({
    url: `${baseURL}api/aicos-second/msc/vehicleOfSocietyApplication/returnVehicle`,
    method: 'post',
    data: row
  })
}
...
export const submitListData = (row) => {
  return request({
    url: `${baseURL}apiaicos-second/msc/vehicleOfSocietyApplication/startProcessInstanceById`,
    method: 'post',
    data: row
  })
}
...
export const auditListData = (form) => {
  return request({
    url: `${baseURL}api/aicos-second/msc/vehicleApplication/updateCompleteTask`,
    method: 'post',
    data:form
  })
}

...
export const reg = (data) => request({
  url: `${baseURL}api/aicos-second/member/save`,
  method: 'post',
  data
});

export const sendMessage = (data) => request({
  url: `${baseURL}api/aicos-second/member/sendMessage`,
  method: 'post',
  data:data
});

export const getMember = () => request({
  url: `${baseURL}api/aicos-second/member/captcha`,
  method: 'get'
});

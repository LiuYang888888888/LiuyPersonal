...
export const getDetailList = (data) => {
  return request({
    url: `${baseURL}api/aicos-second/zzb/trainNotice/queryNoticeDetailsByParam`,
    method: 'post',
    data: data
  })
}
//各处室人员培训统计
export const getDetailListSum = (data) => {
  return request({
    url: `${baseURL}api/aicos-second/zzb/trainNotice/querySummaryDetailsByParam`,
    method: 'post',
    data: data
  })
}